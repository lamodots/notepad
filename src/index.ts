...
async function getNotes() {
  try {
            ...
            <a href="index.html?note=${note.id}">
             ...
             <div class="meta_datas">
                 ...
                 <div class="action_button">
                     <svg  data-id="${
                       note.id
                     }" class="editicon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg data-id="${
                      note.id
                    }" class="deleteicon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    // DELETE NOTE
    const deleteIcons: NodeListOf<Element> =
      document.querySelectorAll(".deleteicon")!;
    ...
    // UPDATE NOTE
    const editIcons: NodeListOf<Element> =
      document.querySelectorAll(".editicon");
    ...
    editIcons.forEach((editicon) => {
      ...
      async function editNote(event: any) {
        ...
        let notebody = document.querySelector(
          "#editnotebody"
